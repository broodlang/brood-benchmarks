...
> **Machine:** `whklat` (12 cores), Linux-7.0.0-22-generic-x86_64-with-glibc2.43 — 2026-06-08 20:56.
...
|------|---------|------------|-----|------|---------|----------|-----|----------|
| brood | — | 1.0× | 1/1 | 280.1ms | — | 11.9 MB | 1/1 | 832040 |

## loop — raw iteration (tail recursion vs for-loop)  (N=3000000)

| lang | compute | vs fastest | pos | wall | startup | peak RSS | mem | checksum |
|------|---------|------------|-----|------|---------|----------|-----|----------|
| brood | — | 1.0× | 1/1 | 240.7ms | — | 11.9 MB | 1/1 | 3000000 |

## collatz — integer arithmetic + tight inner loop  (N=30000)

| lang | compute | vs fastest | pos | wall | startup | peak RSS | mem | checksum |
|------|---------|------------|-----|------|---------|----------|-----|----------|
| brood | — | 1.0× | 1/1 | 381.0ms | — | 21.0 MB | 1/1 | 307 |
