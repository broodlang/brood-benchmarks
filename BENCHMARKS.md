...
`1.00` = that table's fastest column; each score is the geometric mean of a language's time ÷ that row's best. **Scores:** 🟢 within 2× of the leader · 🟠 within 5× · 🔴 beyond. **`vs best`/`vs avg` in the tables:** 🟢 at least as fast · 🟠 up to 3× slower · 🔴 beyond. `·` = no port.
<!-- END SCOREBOARD -->
