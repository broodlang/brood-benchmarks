...
**2026-08-05 run.** Numbers regenerate with each run; the full table is in [BENCHMARKS.md](BENCHMARKS.md).

| | Brood | field |
|---|---|---|
| startup (wall) | 15.9 ms | Python 10.1, Node 18.0, .NET 21.8, Ruby 39.0, Elixir 180.7, Clojure 342.7 ms |
...
| `latency` p99 / p99.9 (20k req/s, 5% of them occupying 500µs) | **68 µs / 461 µs** | Elixir 56 / 80 µs · Python 469 / 607 µs · Node 470 / 565 µs · .NET 719 / 12782 µs — the compute winner has the worst tail |
<!-- END STANDINGS -->
...
Numbers in the docs were measured on `whklat`: a 12-core x86-64 Linux 7.0.0 machine · Brood 0.1.0 (`8b7e616f`) (bytecode VM + tier-1 JIT) · Clojure 1.12.5 / OpenJDK 25.0.3 (HotSpot) · Elixir 1.21.0-dev (b82c44a) / OTP 28 (BeamAsm JIT) · Python 3.14.4 · Node 22.21.0 (V8) · ruby 3.3.8 · .NET 10.0.110 (RyuJIT). 2026-08-05.
<!-- END ENVIRONMENT -->
