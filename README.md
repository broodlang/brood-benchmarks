...
lighter than Elixir/Node on most workloads) and **fast-enough startup** (~21 ms,
~16× ahead of the BEAM); it beats Elixir end-to-end on the short tasks and **runs
neck-and-neck with Node on concurrent I/O**. Its weaknesses are **raw compute**
